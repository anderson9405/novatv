            ...
            <form action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <div class="text-center my-3">
                        <img src="{{ asset('images/no-profile.png') }}" alt="no-photo" class="img-thumbmail" id="preview" width="120px">
                    </div>
                ...
                <div class="d-grid gap-2 mb-3">
                    <button type="submit" class="btn btn-primary btn-block" style="background-color: #336180 ">Agregar <i class="fa fa-save mx-2"></i></button>
                </div>
